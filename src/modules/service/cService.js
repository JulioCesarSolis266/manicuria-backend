// import sService from "./sService.js";
// import mError from "../../middlewares/mError.js";

// const cService = {
//   create: async (req, res) => {
//     try {
//       const service = await sService.create(req.body, req.user);
...
//     try {
//       const service = await sService.getOne(req.params.id, req.user);
...
//     try {
//       const service = await sService.update(req.params.id, req.body, req.user);
...
//     try {
//       const service = await sService.delete(req.params.id, req.user);
